...
class ShaderProcessor:
    ...
    def generate_defines_list_helper(self, input_list):
        """Helper function to generate shader define combinations"""
        if isinstance(input_list, str):
            # Handle parentheses in the input string
            ...
            while str_index < str_length:
                ...
                if current_char == "(" and open_index == -1:
                    ...
                    expanded_group_list = self.generate_defines_list_helper(group_str)
            ...
            # Handle the base case with slashes
        ...
        if len(input_list) == 1:
            ...
            remaining_defines_list = self.generate_defines_list_helper(input_list[1:])
    ...
    def generate_defines_list(self, input_list):
        """Generate all combinations of shader defines"""
        return self.generate_defines_list_helper(input_list)
        ...
        if shader_program_files:
            ...
            for program_file in shader_program_files:
                ...
                if program_config:
                    ...
                    if def_match:
                        autoscribe_program_defines = def_match.group(1).lower().strip()
                        autoscribe_program_defines = re.sub(r"\s+", ";", autoscribe_program_defines)
                ...
                # defines_list = []
                # print(f"{program_name}: {defines_list}")
